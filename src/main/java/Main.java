...
public class Main {
	 ...
	 */
	public static Map<String, Map<RevCommit, LocalDate>> releasesRetrieval(ReleasesManager relMan) throws GitAPIException, IOException{
	 ...
	 */
	public static Map<String, Pair<RevCommit, RevCommit>> fixesRetrieval() throws IOException, GitAPIException{
	 ...
	 */
	public static Map<Pair<RevCommit, RevCommit>, List<String>> retrieveAffectedVersions(Map<String, Pair<RevCommit, RevCommit>> fixes, Map<String, Map<RevCommit, LocalDate>> releases) {
	...
	private static List<String> computeAffectedList(List<List<String>> recordAV, Integer opening, Integer fix) {
